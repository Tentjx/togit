...
public class PlayMusicAcitvity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_music_lrc.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent2=new Intent(PlayMusicAcitvity.this,LrcActivity.class);
				intent2.putExtra("musicName", musicName);
	...
	public void onClick(View view) {
		...
		if (id == R.id.img_play) {
			...
			Intent intent = new Intent(PlayMusicAcitvity.this,
					CurrentPlayList.class);
			Bundle bundleto = new Bundle();
			bundleto.putInt("musicIdto", position);
	...
	class CompletionBroadReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context arg0, Intent intent) {
			...
			if ("completed".equals(broadString)) {
				...
				updateIntent.setAction("com.wtwd.action.UPDATELRC");
				updateIntent.putExtra("musicPath", musicPath);
				updateIntent.putExtra("update", "do");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_OK:
			...
			int musicIdBack = bundleresult.getInt("musicIdBack");
			initView(musicIdBack);
			img_play.setImageResource(R.drawable.pause_nomal);
			img_play.setTag("暂停");
			break;
